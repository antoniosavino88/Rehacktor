...
export default function Sidebar({ isOpen, setIsOpen }) {
  return (
    <>
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen w-55 bg-primary text-text p-8 shadow-lg overflow-y-auto mt-10 transform transition-transform duration-300 ease-in-out z-3 scrollbar-hide ${
